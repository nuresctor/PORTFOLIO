...
if( ! defined( 'WP_APAIOIS_VERSION' ) ) {
	define( 'WP_APAIOIS_VERSION', '1.21' ); // Version of plugin
}
...
if( ! defined( 'WP_APAIOIS_PLUGIN_LINK' ) ) {
	define('WP_APAIOIS_PLUGIN_LINK','https://www.wponlinesupport.com/wp-plugin/sliderspack-one-image-post-slider/?utm_source=WP&utm_medium=SlidersPack&utm_campaign=Features-PRO'); // Plugin link
}
