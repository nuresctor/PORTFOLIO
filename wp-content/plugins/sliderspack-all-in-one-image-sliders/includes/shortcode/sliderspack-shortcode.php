...
function wp_spaios_slider_shortcode( $atts, $content = null) {
	...
	if( $slider_type == '3dslider' ) {
		...
		// Slider Configuration
		$slider_conf = compact('arrow', 'pagination', 'speed', 'autoplay', 'autoplay_speed', 'loop','slide_to_show_3d', 'slide_show_tablet_3d', 'slide_show_mobile_3d', 'slide_to_scroll_3d', 'auto_stop', 'centermode_3d', 'space_between_3d', 'auto_stop_3d', 'depth', 'modifier' );
