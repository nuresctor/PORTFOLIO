	...
	<table class="wpos-plugin-pricing-table">
		...
		<thead>
			<tr>
				...
				<th>
					<h2>Premium</h2>
					<p>Gain access to <strong>SlidersPack</strong> included in <br /><strong>Essential Plugin Bundle</p>
		...
		<tfoot>
			<tr>
				<th></th>
				<td></td>
				<td><p>Gain access to <strong>SlidersPack</strong> included in <br /><strong>Essential Plugin Bundle</p>
				<a href="https://www.wponlinesupport.com/pricing/?ref=WposPratik&utm_source=WP&utm_medium=SlidersPack&utm_campaign=Upgrade-PRO" class="wpos-button" target="_blank">View Pricing Options</a></td>
			</tr>
		</tfoot>
	</table>
</div>